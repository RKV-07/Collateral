...
- **Neutral**: Pure white (#FFFFFF) for primary text and high-priority icons. Mid-greys are reserved for secondary metadata.
- **Dividers**: A subtle charcoal (#262626) is used for 1px hairline borders.

## Typography

This design system utilizes a dual-font strategy to separate narrative from data, moving toward a more geometric and classic sans-serif pairing.

- **Headlines (Inter)**: Chosen for its neutral, highly legible geometry. Headlines should be set with tight letter-spacing and heavy weights to create a sense of structural permanence and professional clarity.
- **Body (Montserrat)**: Provides a slightly more open and warmer reading experience for long-form content while maintaining the architectural feel of the system.
...
### Buttons
- **Primary**: Solid white background with near-black text. Bold Inter typography.
